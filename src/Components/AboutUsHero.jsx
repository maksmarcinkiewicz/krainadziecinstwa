  ...
  return (
    <div className="container mx-auto flex flex-col lg:flex-row items-center justify-center p-4 overflow-x-hidden md:overflow-auto">
      ...
      <div className="w-full lg:w-1/2 mt-10 lg:mt-0">
        ...
        <div className=" mt-10 gap-4 relative w-full flex snap-x  snap-always overflow-x-auto pb-8">
          {achievements.map((achievement, index) => (
            <div
              key={index}
              className="snap-start scroll-ml-4 snap-always shrink-0 w-8/12 border border-slate-100 md:w-1/2 lg:w-1/5 flex flex-col items-start gap-4 justify-center mb-6 shadow-md p-4 rounded-md"
            >
